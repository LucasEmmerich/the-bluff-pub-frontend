    ...
    <div class="min-h-screen overflow-x-hidden" style="background: #0a0603; color: #f0e0c0">
        <section class="relative flex flex-col items-center justify-center min-h-screen overflow-hidden px-6">
            ...
            <div
                ...
                style="background: radial-gradient(ellipse at 50% 55%, rgba(184, 134, 11, 0.08) 0%, transparent 65%)"
            ></div>

            <div class="relative flex flex-col items-center gap-6 text-center z-10">
                <h1
                    class="font-pub font-black text-7xl md:text-9xl tracking-widest hero-title"
                    style="
                        text-shadow:
        ...
        <section class="relative py-24 px-6">
            <div class="max-w-4xl mx-auto">
                ...
                <p class="font-body text-pub-cream/50 text-sm text-center italic mt-8">
                    The deck has 6 Kings, 6 Queens, 6 Jacks and 2 Jokers — 20 cards total. Supports
                    <strong class="text-pub-cream not-italic">2 to 4 players</strong>.
                </p>
            </div>
        </section>
            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="mt-12 flex flex-col gap-8">
                    <StepCard :step="1" title="The Table Sets the Card">
                        At the start of each round, the table card is revealed:
                        <strong class="text-pub-gold">King</strong>, <strong class="text-pub-gold">Queen</strong> or
                        <strong class="text-pub-gold">Jack</strong>. Every player receives
                        <strong class="text-pub-cream">5 cards</strong> in hand.
                    </StepCard>
                    ...
                    <StepCard :step="2" title="Play Cards... or Lie">
                        ...
                        <strong class="text-pub-gold">face down</strong> on the table, claiming they are all the round's
                        card type. The truth? Only you know.
                    </StepCard>

                    <StepCard :step="3" title="The Joker is Wild">
                        The <strong class="text-pub-gold">Joker</strong> counts as any card — King, Queen or Jack. Use
                        it to save a weak hand or bluff with extra confidence.
                    </StepCard>

                    <StepCard :step="4" title="Accuse or Trust">
                        After each play, any player — on <strong class="text-pub-cream">their turn</strong> — can shout
                        <strong class="text-pub-gold">"LIAR!"</strong> and reveal the table cards. Or they can play
                        their own cards and continue the round.
                    </StepCard>
                </div>
            </div>
        </section>
        ...
        <section class="relative py-24 px-6">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div
                        class="p-6 rounded-xl flex flex-col gap-4"
                    ...
                    >
                        ...
                        <p class="font-body text-pub-cream/60 text-sm text-center leading-relaxed">
                            The revealed cards <strong class="text-red-400">were not</strong> the right type. The player
                            who played them loses <strong class="text-pub-cream">1 life</strong>. The accuser was right.
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <p class="font-body text-pub-cream/60 text-sm text-center leading-relaxed">
                            The revealed cards <strong class="text-green-400">were</strong> all the right type. The
                            accuser loses <strong class="text-pub-cream">1 life</strong>. Think twice.
                        </p>
                    </div>
                </div>
            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="mt-12 flex flex-col items-center gap-10">
                    <div class="flex flex-col items-center gap-3">
                        <div class="flex gap-3 text-3xl"><span>❤️</span><span>❤️</span><span>❤️</span></div>
                        <p class="font-body text-pub-cream/60 text-sm text-center max-w-xs">
                            Every player starts with <strong class="text-pub-cream">3 lives</strong>. Each penalty
                            removes one.
                        </p>
                    </div>

                    <div
                        class="h-px w-full max-w-xs"
                    ...
                    <div class="flex flex-col items-center gap-3">
                        ...
                        <p class="font-body text-pub-cream/60 text-sm text-center max-w-xs">
                            With <strong class="text-pub-cream">1 life</strong> left, one mistake means elimination.
                    ...
                    <div class="flex flex-col items-center gap-3">
                        <div
                            ...
                            style="filter: drop-shadow(0 0 16px rgba(184, 134, 11, 0.5))"
                        >
                            🏆
                        </div>
                        <p class="font-body text-pub-cream/60 text-sm text-center max-w-xs">
                            The <strong class="text-pub-gold">last survivor</strong> with lives remaining wins the
                            match.
                        </p>
                    </div>
                </div>
            ...
            <div class="max-w-5xl mx-auto">
                ...
                <div class="mt-12 grid md:grid-cols-4 gap-5">
                    <TipCard icon="🃏" title="Save the Joker">
                        The Joker is your most powerful card. Use it when your hand is weak and you need to bluff with
                        confidence.
                    </TipCard>
                    <TipCard icon="👁️" title="Watch the Others">
                        How many cards does each player have? Someone who plays too fast may be very confident — or
                        scared.
                    </TipCard>
                    ...
                    <TipCard icon="⏱️" title="Watch the Clock">
                        Each turn has a time limit. Anyone who neither plays nor calls LIAR! automatically loses a life.
                    </TipCard>
                </div>
            </div>
        </section>
        ...
        <section
            class="relative py-24 px-6 flex flex-col items-center gap-8 text-center"
            style="background: radial-gradient(ellipse at 50% 50%, rgba(184, 134, 11, 0.06) 0%, transparent 65%)"
        >
            <div
                class="h-px w-48"
                style="background: linear-gradient(to right, transparent, #b8860b66, transparent)"
            ></div>

            <div class="text-5xl" style="filter: drop-shadow(0 0 20px rgba(184, 134, 11, 0.4))">🂡</div>

            <h2
                class="font-pub text-4xl md:text-5xl font-black tracking-widest"
...
import {
    ...
    jack as jackImg,
    joker as jokerImg,
    no_card as noCardImg,
} from "~/assets/cards";

useHead({ title: "Rules — Bluff Pub" });

const deckCards = [
    {
        name: "King",
        src: kingImg,
        description: "The king of the table. Play with confidence — or conviction.",
        special: false,
    },
    { name: "Queen", src: queenImg, description: "The queen. Hard to read, easy to bluff with.", special: false },
    {
        name: "Jack",
        src: jackImg,
        description: "The jack. Simple, direct and devastating in the right hands.",
        special: false,
    },
...
@keyframes float-card {
    0% {
        opacity: 0;
        transform: translateY(0px) rotate(var(--r, 0deg)) scale(var(--s, 1));
    }
    10% {
        opacity: 0.12;
    }
    50% {
        opacity: 0.18;
        transform: translateY(-22px) rotate(var(--r, 0deg)) scale(var(--s, 1));
    }
    90% {
        opacity: 0.12;
    }
