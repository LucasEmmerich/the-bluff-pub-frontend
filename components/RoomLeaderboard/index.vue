    ...
    >
        ...
        <div class="flex flex-col px-2 py-1.5">
            ...
            >
                ...
                <span class="font-pub text-[10px] flex-1 truncate" style="color: rgba(255, 248, 238, 0.7)">{{
                    entry.player.username
                }}</span>
                <span class="font-pub font-black text-[9px]" style="color: rgba(184, 134, 11, 0.75)">{{
                    entry.wins
                }}</span>
            </div>
        </div>
...
const sorted = computed(() => [...props.entries].sort((a, b) => b.wins - a.wins));
