<template>
    <div class="relative flex flex-col h-full shrink-0 items-center justify-center px-5 py-8 gap-6"
        ...
        <div class="flex flex-col items-center gap-3 w-full px-4 py-4 rounded-xl"
            ...
            <img :src="avatars[_room.mainPlayer.avatar as number]"
            ...
            <div class="flex items-center gap-2">
                ...
                <button v-if="!_room.id" @click="showEditModal = true"
        ...
        <div class="flex flex-col gap-5 w-full" v-if="_room.id">
            ...
            <div class="flex flex-col items-center gap-3 w-full px-1 py-4 rounded-xl"
